...
from ai_rpg_core.character_backgrounds import king_alof_backstory
from ai_rpg_core.inventory import king_alof_inventory
...
llm_chosen = st.radio("LLM", ("GPT-mini"), key="llm_chosen")
st.text_area("Initial inventory: ", game.inventory,disabled=True)

def create_conversation_chain():
    llm = None
    if llm_chosen == "GPT-mini":
